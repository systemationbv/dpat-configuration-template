...
#### Users guide
Click [here](https://raw.githubusercontent.com/systemationbv/dpat-configuration-template/blob/main/docs/Rabobank-DPAT-Configuration-Template.pdf) for the graphical users guide
